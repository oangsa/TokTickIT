...
| UI-27 | UI | AC-20, AC-38 | Attachment preview modal. | Both Pending and Active owned supported image/PDF fixtures open the modal; Pending preview/download works before Ticket binding; Download is available; Escape/close works; focus trap/return and accessible modal semantics hold. | tests/lab-02/AttachmentSection.test.tsx | Not Run |
