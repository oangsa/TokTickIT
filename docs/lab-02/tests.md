...
| Attachment checks/indexes (AC-56, AC-63) | PG-08, DATA-08 | Inspect and exercise committed Attachment checks plus the bound-row hard-delete trigger and general/partial/unique/trigram/cleanup indexes; verify the size invariant `size_bytes > 0 AND size_bytes <= 5000000 AND size_bytes = octet_length(data)` and record schema evidence without asserting an exact query plan. | Passed — PG-07 schema evidence + PG-08 |
