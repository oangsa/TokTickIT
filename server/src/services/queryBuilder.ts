...
export function buildFilter(expression: QueryExpression): QueryFilter {
   ...
   *
   * This expansion can grow with the number of values. The calling resource
   * owns cardinality validation and any domain-specific optimization; this
   * generic builder does not choose limits or inspect resource fields.
   */
